...
from PyQt5.QtWidgets import QApplication, QWidget, QPushButton, QLineEdit, QGridLayout, QTableWidget, QTableWidgetItem
...
class MainWindow(QWidget):
    def __init__(self):
        ...
        # Cria uma tabela na parte inferior da janela com tamanho fixo
        self.tabela = QTableWidget(self)
        self.tabela.setFixedSize(1080, 780) # Define o tamanho da tabela como 600 x 200 pixels
        ...
        layout.addWidget(self.tabela) # Adiciona a tabela ao layout, abaixo dos botões
    ...
    def window_template(self):
        ...
        self.new_window.setGeometry(700, 175, 600, 150)
    ...
    def get_AgendaEnvioOsWhats(self):
        ...
        if (teste2 == "200"):
            QMessageBox.information(self, "OS" + idOS + " agendada com sucesso!")
        else:
            QMessageBox.critical(self, "Mensagem de erro", teste2)
    ...
    def get_estornaOS(self):
        ...
        if (teste2 == "200"):
            QMessageBox.information(self, "OS" + idOS + "estornada com sucesso!")
        else:
            QMessageBox.critical(self, "Mensagem de erro", teste2)
